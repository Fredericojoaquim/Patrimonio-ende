...
class CreateAbateMaterialEscritorioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('abate_material_escritorio', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('abate_material_escritorio');
    }
}
