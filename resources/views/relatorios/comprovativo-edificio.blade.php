    ...
    <div style="width: 750px; padding:30px;" >
        ...
        <table   style="border: 1px solid black; margin: 0 auto; width: 100%; text-align:center;">
            <tr style="border: 1px solid black; background-color:black; color:white; height: 40px;">
                ...
                <td style="border: 1px solid black;">COMPROVATIVO DE CADASTRO EDIFÍCIO</td>
                @php
            ...
            <tr style="border: 1px solid black;">
                ...
                <td style="border: 1px solid black; ">Nº andar: {{$v->num_andar}} </td>
            </tr>

            <tr style="border: 1px solid black;">
                
                <td style="border: 1px solid black;">Nº Apartamentos:{{$v->num_apartamento}}</td>
