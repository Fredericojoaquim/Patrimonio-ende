                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        ...
                                        @switch($o->estado)
                                            @case('Pendente')
                                            <a href="{{URL("tecnica/movel/diagnosticar/$o->id")}}" class="btn btn-sm active">Diagnósticar</a>
                                            @break
                                            @case('Diagnosticando')
                                            <a href="{{url("tecnica/movel/resolver/$o->id")}}" class="btn btn-sm active">Resolver</a>
                                            @break
                                            @case('Resolvendo')
                                            ...
                                            @case('Concluído')
                                            <a href="{{url("tecnica/movel/informacao/$o->id")}}"   class="btn btn-sm active"> informação</a>
                                            @break
                                            @default
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{url('tecnica/movel/concluir')}}" method="POST" id="form-registar">
                    @csrf
