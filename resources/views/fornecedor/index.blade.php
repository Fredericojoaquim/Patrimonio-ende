...
<div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  action = "{{url('fornecedor/registar')}}"   method="Post" enctype="multipart/form-data" id="form-registar">
                                        @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                    ...
                                                    <input id="nif" name="nif" type="text" placeholder="" class="form-control">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                    ...
                                                    <input id="telefone" name="telefone" type="text" placeholder="" class="form-control">
