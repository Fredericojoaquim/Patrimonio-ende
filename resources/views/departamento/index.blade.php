...
<div class="card">
                                    <h3 class="card-header">Registar Departamento</h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  action = "{{url('departamento/registar')}}"   method="Post" enctype="multipart/form-data" id="form-registar">
                                        @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                    ...
                                                    <input id="sigla" name="sigla" type="text" placeholder="" class="form-control">
