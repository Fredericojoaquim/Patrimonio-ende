...
<div class="card">
                                    <h3 class="card-header">Alterar Terreno</h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  action = "{{url('imoveis/terreno/update')}}"   method="Post" enctype="multipart/form-data" id="form-registar">
                                        @csrf
                                        {{ method_field('PUT') }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12">
                                                    ...
                                                    <input id="numimobilizado" value="{{$te->num_imobilizado}}" name="numimobilizado" type="text" class="form-control">
                                                </div>

                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                    <label for="descricao">Descrição</label>
                                                    <input id="descricao" value="{{$te->descricao}}" name="descricao" type="text" placeholder="" class="form-control">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12">
                                                    ...
                                                    <input id="valoraquisicao" value="{{$te->valor_aquisicao}}" onkeyup="changeValue(this)" name="valoraquisicao" type="text" class="form-control">
                                                </div>

                                                <div class="form-group col-lg-6 margin-input">
                                                    <label for="Custo_aquisição_usd">Custo aquisição (USD)</label>
                                                    <input id="Custo_aquisição_usd" value="{{$te->custo_aquisicao_usd}}"  onkeyup="changeValue(this)" type="text" name="Custo_aquisiçao_usd" placeholder="" class="form-control">
                                                 </div>

                                                 <div class="form-group col-lg-6">
                                                    <label for="Custo_aquisição_euro" class="col-form-label">Custo aquisição (euro)</label>
                                                    <input id="Custo_aquisição_euro" value="{{$te->custo_aquisicao_euro}}"  onkeyup="changeValue(this)" type="text" name="Custo_aquisiçao_euro"   class="form-control" placeholder="">
                                                </div>

                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                    <label for="finalidade">Finalidade</label>
                                                    <input id="finalidade" name="finalidade"  value="{{$te->finalidade}}" type="text" placeholder="" class="form-control">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                    ...
                                                    <input id="dataaquisicao"  value="{{$te->data_aquisicao}}" name="dataaquisicao" type="date" placeholder="" class="form-control">
                                            ...
                                            <div class="row">
                                                ...
                                                <input id="municipio" value="{{$te->municipio}}" name="municipio" type="text" placeholder="" class="form-control">
                                                </div>


                                                <div class="form-group col-lg-6 col-md-12">
                                                <label for="bairro" class="col-form-label">Bairro</label>
                                                <input id="bairro" value="{{$te->bairro}}" name="bairro" type="text" class="form-control">
                                                </div>

                                                <div class="form-group col-lg-6 col-md-12 margin-input">
                                                <label for="rua">Rua</label>
                                                <input id="rua" name="rua" value="{{$te->rua}}" type="text" placeholder="" class="form-control">
                                            ...
                                            <div class="text-right">
                                                <input type="hidden" name="id" value="{{$te->codigo}}">
                                                <input type="hidden" name="endereco_id" id="endereco_id" value="{{$te->endereco_id}}">
