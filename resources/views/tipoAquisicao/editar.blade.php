...
<div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  action = "{{url('tipoaquisicao/update')}}"   method="Post" enctype="multipart/form-data" id="form-registar">
                                        @csrf
                                        {{ method_field('PUT') }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-12 col-md-12">
                                                    ...
                                                    <input id="descricao" name="descricao" value="{{$t->descricao}}" type="text" class="form-control">
                                                    <input id="id" name="id" value="{{$t->id}}" type="hidden" class="form-control">
                                                </div>
                                                @endif
